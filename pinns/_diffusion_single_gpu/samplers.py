...
class ICUniformSampler(BaseSampler):
...
class UniformBoundarySampler(BaseSampler):
    def __init__(self, boundaries_x, boundaries_y, T, batch_size):
        super().__init__(batch_size)
        self.boundary_x = boundaries_x
        self.boundary_y = boundaries_y
        self.T = T
        self.num_boundaries = 3
...
# class UniformBoundarySampler(BaseSampler):
#     def __init__(
#         self, boundaries_x, boundaries_y, T, batch_size
#     ):
#         super().__init__(batch_size)
#         self.boundary_x = boundaries_x
#         self.boundary_y = boundaries_y
...
#                         np.stack(
#                             [
#                                 self.boundary_x[outer_key][inner_key][idx],
#                                 self.boundary_y[outer_key][inner_key][idx],
#                             ],
#                             axis=1,
#                         ),
#                         self.rng.uniform(size=(self.batch_size, 1)) * self.T,
