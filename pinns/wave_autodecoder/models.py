...
class Wave(MPINN):
    ...
    def r_net(self, params, d_params, x, y, t):
        u_t = lambda t: grad(self.u_net, argnums=3)(params, x, y, t)
        u_tt = grad(u_t, argnums=0)(t)
        return u_tt - self.c2 * self.laplacian_net(params, d_params, x, y, t)

    def losses(self, params, batch):

        res_batches, boundary_batches, ics_batches, ics_derivative_batches = batch
        ...
        ics_derivative_loss = jnp.mean(ics_derivative_loss)
