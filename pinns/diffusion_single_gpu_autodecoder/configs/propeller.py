...
def get_config():
    ...
    profiler.log_dir = "pinns/diffusion_single_gpu/propeller/profiler"

    # Saving
    config.saving = saving = ml_collections.ConfigDict()
    saving.checkpoint_dir = (
        "pinns/diffusion_single_gpu/propeller/checkpoints/"
    ...
    eval.checkpoint_dir = "pinns/diffusion_single_gpu/propeller/checkpoints/"
    eval.step = 11000
