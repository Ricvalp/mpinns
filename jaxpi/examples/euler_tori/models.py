...
class Euler(ForwardIVP):
    ...
    def compute_diag_ntk(self, params, batch):
        u_ic_ntk = vmap(ntk_fn, (None, None, 0, 0, 0))(
            self.u_net, params, 0.0, self.xy[:, 0], self.xy[:, 1]
        )
        v_ic_ntk = vmap(ntk_fn, (None, None, 0, 0, 0))(
            self.v_net, params, 0.0, self.xy[:, 0], self.xy[:, 1]
        )
        rho_ic_ntk = vmap(ntk_fn, (None, None, 0, 0, 0))(
            self.rho_net, params, 0.0, self.xy[:, 0], self.xy[:, 1]
        )
