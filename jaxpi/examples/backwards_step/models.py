...
class NavierStokes2D(ForwardBVP):
    def __init__(
        ...
        self.noslip_coords = wall_coords
    ...
    def neural_net(self, params, x, y):
        x = (
            x
        ) / self.L  # HACK HACK HACK (TODO: remove in the future) # rescale x into [0, 1]
    ...
    def r_net(self, params, x, y):
        ...
        # outflow boundary residual (TODO: check if this is correct)
        # just setting the pressure over here
        u_out = p
        v_out = p
